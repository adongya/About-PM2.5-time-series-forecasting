...
def VMD(signal, K):
    ...
    # plt.subplot(9, 1, 1), plt.plot(signal[:1000], 'k'), plt.legend(loc=1,labels=["原始信号"],fontsize=12)
    # plt.subplot(9, 1, 2), plt.plot(u[0][:1000],'k'),plt.ylabel("分量1")
    # plt.subplot(9, 1, 3), plt.plot(u[1][:1000],'k'),plt.ylabel("分量2")
    # plt.subplot(9, 1, 4), plt.plot(u[2][:1000],'k'),plt.ylabel("分量3")
    # plt.subplot(9, 1, 5), plt.plot(u[3][:1000],'k'),plt.ylabel("分量4")
    # plt.subplot(9, 1, 6), plt.plot(u[4][:1000],'k'),plt.ylabel("分量5")
    # plt.subplot(9, 1, 7), plt.plot(u[5][:1000],'k'),plt.ylabel("分量6")
    # plt.subplot(9, 1, 8), plt.plot(u[6][:1000],'k'),plt.ylabel("分量7")
    # plt.subplot(9, 1, 9), plt.plot(u[7][:1000],'k'),plt.ylabel("分量8")
